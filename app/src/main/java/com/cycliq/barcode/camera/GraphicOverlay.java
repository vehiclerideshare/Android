 ...
 */
package com.cycliq.barcode.camera;
...
import com.cycliq.barcode.camera.*;
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    private int mFacing = com.cycliq.barcode.camera.CameraSource.CAMERA_FACING_BACK;
    ...
    public static abstract class Graphic {
        ...
        public float translateX(float x) {
            if (mOverlay.mFacing == com.cycliq.barcode.camera.CameraSource.CAMERA_FACING_FRONT) {
