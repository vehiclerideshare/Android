...
import com.cycliq.barcode.*;
import com.cycliq.barcode.camera.GraphicOverlay;
...
class BarcodeGraphicTracker extends Tracker<Barcode> {
    private GraphicOverlay<com.cycliq.barcode.BarcodeGraphic> mOverlay;
    private com.cycliq.barcode.BarcodeGraphic mGraphic;
    private BarcodeGraphicTrackerListener listener;

    BarcodeGraphicTracker(GraphicOverlay<com.cycliq.barcode.BarcodeGraphic> overlay, com.cycliq.barcode.BarcodeGraphic graphic, BarcodeGraphicTrackerListener listener) {
        mOverlay = overlay;
        mGraphic = graphic;
