...
import com.cycliq.R;
import com.cycliq.barcode.camera.CameraSourcePreview;
...
public class BarcodeReader extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    private com.cycliq.barcode.camera.CameraSource mCameraSource;
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        com.cycliq.barcode.camera.CameraSource.Builder builder;





        builder = new com.cycliq.barcode.camera.CameraSource.Builder(getActivity(), barcodeDetector)
